...
List<RingEntityCompanion> rings = [
  const RingEntityCompanion(
    ...
    ringSeriesCode: d.Value('T'),
    ringIdNumber: d.Value('44'),
    metalRingInfo: d.Value('1'),
    species: d.Value('ANA.CLY'),
    age: d.Value('3'),
    sex: d.Value('F'),
